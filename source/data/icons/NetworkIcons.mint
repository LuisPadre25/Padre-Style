/* Network Icons - Network and connectivity icons */
module NetworkIcons {
  const WIFI =
  ...
  const NETWORK =
    "<path d='M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3'/><path d='M12 12V8'/><rect width='20' height='8' x='2' y='4' rx='2'/><rect width='8' height='4' x='8' y='14' rx='1'/>"

  const ORBIT =
    "<circle cx='12' cy='12' r='3'/><path d='M20.341 6.484A10 10 0 0 1 10.266 21.85'/><path d='M3.659 17.516A10 10 0 0 1 13.74 2.152'/>"
