component NewShowcase {
  ...
  fun renderLayoutTab : Html {
    <div::tabContent>
      ...
      <div::demoGrid>
        ...
        <Card title="💪 Flex Grow - flex: 1">
          <Flex gap="0.5rem">
            <FlexItem flex="1">
              <div
                style="padding: 1rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px; text-align: center; color: white;"
              >"flex: 1"</div>
            </FlexItem>

            <FlexItem flex="1">
              <div
                style="padding: 1rem; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 8px; text-align: center; color: white;"
              >"flex: 1"</div>
            </FlexItem>

            <FlexItem flex="1">
              <div
                style="padding: 1rem; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 8px; text-align: center; color: white;"
              >"flex: 1"</div>
            </FlexItem>
          </Flex>
        ...
        <Card title="📏 Flex Basis - Ancho fijo + flex">
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"Sidebar fijo + contenido flexible"</p>
        </Card>
        ...
        <Card title="🔢 Order - Reordenar items">
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"Se muestran: Segundo → Tercero → Primero"</p>
        </Card>
        ...
        <Card title="🎨 Align Self - Alineación individual">
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"alignSelf anula align del padre"</p>
        </Card>
        ...
        <Card title="🚀 Dashboard Real con Flex">
          <Flex direction="column" gap="1rem">
            <Flex justify="space-between" align="center">
              ...
              <FlexItem><Badge variant="success">"Live"</Badge></FlexItem>
            </Flex>
            ...
            <Flex gap="1rem">
              <FlexItem flex="2">
                ...
                >
                  <h4
                    style="margin: 0 0 0.5rem 0; color: #{ThemeHelpers.getTextSecondary(
            ...
            <Flex gap="0.5rem">
              <FlexItem flex="1"><Button>"Cancel"</Button></FlexItem>
              <FlexItem flex="1"><Button variant="success">"Save"</Button></FlexItem>
            </Flex>
          </Flex>
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"Layout completo con Flex anidado"</p>
        </Card>
        ...
        <Card title="📱 Responsive Layout - 70/30">
          <Flex gap="1rem" wrap="wrap">
            <FlexItem grow="1" shrink="1" basis="300px">
              <div
                style="padding: 1.5rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px; color: white;"
              >
            ...
            <FlexItem grow="0" shrink="0" basis="200px">
              <div
                style="padding: 1.5rem; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 8px; color: white;"
              >
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"wrap='wrap' - Se apilan en móvil"</p>
        </Card>
      </div>

      <h3::sectionTitle style={getSectionTitleStyles() + "margin-top: 3rem;"}>
        "Grid Avanzado - Layouts Profesionales"
      </h3>
      ...
      <div
        style="text-align: center; margin-bottom: 2rem; padding: 1rem; background: #{ThemeHelpers.getElevated(
          currentTheme)}; border-radius: 8px; border: 2px solid #{ThemeHelpers.getBorderPrimary(
          currentTheme)};"
      >
        <h4
          style="margin: 0 0 0.5rem 0; color: #{ThemeHelpers.getTextPrimary(
            currentTheme)};"
        >"📱 Todos los Grids son RESPONSIVE"</h4>

        <p
          style="margin: 0; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
            currentTheme)};"
        >"Desktop: N columnas → Tablet: 2 columnas → Móvil: 1 columna"</p>

        <p
          style="margin: 0.5rem 0 0 0; font-size: 0.75rem; color: #{ThemeHelpers.getTextSecondary(
            currentTheme)};"
        >
      ...
      <div::demoGrid>
        <Card title="🎯 Grid Básico - 4 Columnas">
          <Grid columns={4} gap="0.5rem">
            <div
              style="padding: 1rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 6px; text-align: center; color: white; font-weight: 600;"
            >"1"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 6px; text-align: center; color: white; font-weight: 600;"
            >"2"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 6px; text-align: center; color: white; font-weight: 600;"
            >"3"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); border-radius: 6px; text-align: center; color: white; font-weight: 600;"
            >"4"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); border-radius: 6px; text-align: center; color: white; font-weight: 600;"
            >"5"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #30cfd0 0%, #330867 100%); border-radius: 6px; text-align: center; color: white; font-weight: 600;"
            >"6"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); border-radius: 6px; text-align: center; color: #333; font-weight: 600;"
            >"7"</div>

            <div
              style="padding: 1rem; background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%); border-radius: 6px; text-align: center; color: #333; font-weight: 600;"
            >"8"</div>
          </Grid>
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"columns={4} gap='0.5rem'"</p>
        </Card>

        <Card title="📦 Grid - Product Cards">
          <Grid columns={3} gap="1rem">
            <div
              style="padding: 1rem; background: #{ThemeHelpers.getElevated(
                currentTheme)}; border: 2px solid #{ThemeHelpers.getBorderPrimary(
                currentTheme)}; border-radius: 8px; text-align: center;"
            >
              <div
                style="aspect-ratio: 1; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 6px; margin-bottom: 0.5rem;"
              />

              <p
                style="margin: 0; font-weight: 600; color: #{ThemeHelpers.getTextPrimary(
                  currentTheme)};"
              >"Product 1"</p>

              <p
                style="margin: 0.25rem 0 0 0; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
                  currentTheme)};"
              >"$29.99"</p>
            </div>
            ...
            >
              <div
                style="aspect-ratio: 1; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 6px; margin-bottom: 0.5rem;"
              />
            ...
            >
              <div
                style="aspect-ratio: 1; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 6px; margin-bottom: 0.5rem;"
              />
        ...
        <Card title="🎨 Auto-Fit - Responsive Magic">
          <Grid autoFit={true} minColumnWidth="120px" gap="1rem">
            ...
            <div
              style="padding: 1.5rem; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 8px; text-align: center; color: white;"
            >
              <h4 style="margin: 0; font-size: 1.5rem;">"💻"</h4>
            ...
            <div
              style="padding: 1.5rem; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); border-radius: 8px; text-align: center; color: white;"
            >
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"Se adapta automáticamente al espacio"</p>
        </Card>
        ...
        <Card title="📐 Different Gaps - columnGap & rowGap">
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"columnGap='2rem' rowGap='0.5rem'"</p>
        </Card>
        ...
        <Card title="🖼️ Image Gallery">
          <Grid autoFit={true} minColumnWidth="100px" gap="0.5rem">
            ...
            <div
              style="aspect-ratio: 1; background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); border-radius: 8px;"
            />

            <div
              style="aspect-ratio: 1; background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%); border-radius: 8px;"
            />

            <div
              style="aspect-ratio: 1; background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); border-radius: 8px;"
            />
          </Grid>
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"Instagram-style gallery"</p>
        </Card>

        <Card title="💎 Dashboard Stats Grid">
          <Grid columns={2} gap="1rem">
            <div
              style="padding: 1.5rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; color: white;"
            >
              ...
              <h3
                style="margin: 0.5rem 0 0 0; font-size: 2.5rem; font-weight: 700;"
              >"12.5K"</h3>

              <p
                style="margin: 0.25rem 0 0 0; font-size: 0.75rem; opacity: 0.8;"
              >"↗ +12% desde ayer"</p>
            </div>

            <div
              style="padding: 1.5rem; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); border-radius: 12px; color: white;"
            >
            ...
            <div
              style="padding: 1.5rem; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 12px; color: white;"
            >
            ...
            <div
              style="padding: 1.5rem; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 12px; color: white;"
            >
              <p style="margin: 0; font-size: 0.875rem; opacity: 0.9;">
                "Conversion"
              </p>
          ...
          <p
            style="margin-top: 1rem; font-size: 0.875rem; color: #{ThemeHelpers.getTextSecondary(
              currentTheme)}; text-align: center;"
          >"Analytics dashboard with stats"</p>
        </Card>
        ...
        <Card title="🎯 Icon Grid - Features">
          <Grid autoFit={true} minColumnWidth="140px" gap="1.5rem">
            <div style="text-align: center;">
              <div
                style="width: 60px; height: 60px; margin: 0 auto 0.75rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.75rem;"
              >"⚡"</div>

              <h4
                style="margin: 0; color: #{ThemeHelpers.getTextPrimary(
                  currentTheme)}; font-size: 1rem;"
              >"Fast"</h4>
            ...
            <div style="text-align: center;">
              <div
                style="width: 60px; height: 60px; margin: 0 auto 0.75rem; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.75rem;"
              >"🔒"</div>
            ...
            <div style="text-align: center;">
              <div
                style="width: 60px; height: 60px; margin: 0 auto 0.75rem; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.75rem;"
              >"🎨"</div>
    ...
    <div::tabContent>
      ...
      >
        <h4
          style="margin: 0 0 0.5rem 0; color: #{ThemeHelpers.getTextPrimary(
            currentTheme)};"
        >"💻 Syntax Highlighting para todos los lenguajes"</h4>
